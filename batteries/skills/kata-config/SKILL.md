---
description: "Configure kata in this project — detects kata source repo, fresh projects, or reconfiguration."
---

# /kata-config

Configure kata for this project. Follow the scenario that matches the current directory.
...
4. Tell the user: kata is ready. Open Claude Code in any project and run `/kata-config` to configure it.
...
1. Check `kata` is in PATH: `which kata`
   - If NOT found: tell the user to install kata first (clone the repo and run `/kata-config` there).
